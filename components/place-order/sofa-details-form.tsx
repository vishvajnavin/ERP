...
export const SofaDetailsForm: React.FC<DetailsFormProps<ProductWithFiles>> = ({ index, product, handleProductChange, disabled, baseName, nameError }) => {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <ComboboxField name={`${baseName}.model_family_configuration`} label="Model Family Configuration" placeholder="Select Configuration" value={product.model_family_configuration} disabled={disabled} onValueChange={(val) => handleProductChange(index, "model_family_configuration", val)} options={modelFamilyOptions} required/>
            {(product.model_family_configuration === '3+2 str' || product.model_family_configuration === '3+2+1') && (
                <InputField name={`${baseName}.2_seater_length`} label="2 Seater Length (cm)" type="number" value={product['2_seater_length'] || ''} disabled={disabled} onChange={(e) => handleProductChange(index, "2_seater_length", Number(e.target.value))} required/>
            )}
            {product.model_family_configuration === '3+2+1' && (
                <InputField name={`${baseName}.1_seater_length`} label="1 Seater Length (cm)" type="number" value={product['1_seater_length'] || ''} disabled={disabled} onChange={(e) => handleProductChange(index, "1_seater_length", Number(e.target.value))} required/>
            )}
            ...
            <ToggleGroupField name={`${baseName}.leg_type`} label="Leg Type" value={product.leg_type} disabled={disabled} onValueChange={(val) => handleProductChange(index, "leg_type", val)} options={[{value: 'wood', label: 'Wood'}, {value: 'pvd', label: 'PVD'}, {value: 'ss', label: 'SS'}]} required/>
            <InputField name={`${baseName}.pvd_color`} label="PVD Color" value={product.pvd_color || ''} disabled={disabled} onChange={(e) => handleProductChange(index, "pvd_color", e.target.value)} required/>
            <ToggleGroupField name={`${baseName}.chester_option`} label="Chester Option" value={product.chester_option} disabled={disabled} onValueChange={(val) => handleProductChange(index, "chester_option", val)} options={[{value: 'with_button', label: 'With Button'}, {value: 'without_button', label: 'Without Button'}]} required/>
            <InputField name={`${baseName}.armrest_panels`} label="Armrest Panels" value={product.armrest_panels || ''} disabled={disabled} onChange={(e) => handleProductChange(index, "armrest_panels", e.target.value)} required/>
            <InputField name={`${baseName}.polish_color`} label="Polish Color" value={product.polish_color || ''} disabled={disabled} onChange={(e) => handleProductChange(index, "polish_color", e.target.value)} required/>
            <ToggleGroupField name={`${baseName}.polish_finish`} label="Polish Finish" value={product.polish_finish} disabled={disabled} onValueChange={(val) => handleProductChange(index, "polish_finish", val)} options={[{value: 'matt_finish', label: 'Matt Finish'}, {value: 'glossy_finish', label: 'Glossy Finish'}]} required/>
            <InputField name={`${baseName}.total_width`} label="Total Width (cm)" type="number" value={product.total_width || ''} disabled={disabled} onChange={(e) => handleProductChange(index, "total_width", Number(e.target.value))} required/>
            <InputField name={`${baseName}.total_depth`} label="Total Depth (cm)" type="number" value={product.total_depth || ''} disabled={disabled} onChange={(e) => handleProductChange(index, "total_depth", Number(e.target.value))} required/>
            <InputField name={`${baseName}.total_height`} label="Total Height (cm)" type="number" value={product.total_height || ''} disabled={disabled} onChange={(e) => handleProductChange(index, "total_height", Number(e.target.value))} required/>
            <InputField name={`${baseName}.seat_width`} label="Seat Width (cm)" type="number" value={product.seat_width || ''} disabled={disabled} onChange={(e) => handleProductChange(index, "seat_width", Number(e.target.value))} required/>
            <InputField name={`${baseName}.seat_depth`} label="Seat Depth (cm)" type="number" value={product.seat_depth || ''} disabled={disabled} onChange={(e) => handleProductChange(index, "seat_depth", Number(e.target.value))} required/>
            <InputField name={`${baseName}.seat_height`} label="Seat Height (cm)" type="number" value={product.seat_height || ''} disabled={disabled} onChange={(e) => handleProductChange(index, "seat_height", Number(e.target.value))} required/>
            <InputField name={`${baseName}.armrest_width`} label="Armrest Width (cm)" type="number" value={product.armrest_width || ''} disabled={disabled} onChange={(e) => handleProductChange(index, "armrest_width", Number(e.target.value))} required/>
            <InputField name={`${baseName}.armrest_depth`} label="Armrest Depth (cm)" type="number" value={product.armrest_depth || ''} disabled={disabled} onChange={(e) => handleProductChange(index, "armrest_depth", Number(e.target.value))} required/>
            <ComboboxField name={`${baseName}.upholstery`} label="Upholstery" placeholder="Select Upholstery" value={product.upholstery} disabled={disabled} onValueChange={(val) => handleProductChange(index, "upholstery", val)} options={upholsteryOptions} required/>
            <InputField name={`${baseName}.upholstery_color`} label="Upholstery Color" value={product.upholstery_color || ''} disabled={disabled} onChange={(e) => handleProductChange(index, "upholstery_color", e.target.value)} required/>
        </div>
    );
};
